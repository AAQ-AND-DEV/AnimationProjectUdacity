...
class LoadingButton @JvmOverloads constructor(
    ...
    private fun applyCustomAttrs(context: Context, attrs: AttributeSet?) {
...
//          Log.d("button", "animatedValue: ${valueAnimator.animatedValue}")
    ...
    private var buttonState: ButtonState by Delegates.observable<ButtonState>(ButtonState.Completed) { p, old, new ->
        Log.d("loadingButton", "state was $old, now is $new")
        when (new) {
            ButtonState.Clicked -> {
            }
            ButtonState.Loading -> {
